...
//  GPIO-06 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO6 = 0;		// 0=GPIO,  1=EPWM4A,  2=SYNCI,  3=SYNCO	GpioCtrlRegs.GPADIR.bit.GPIO6 = 0;		// 1=OUTput,  0=INput
	GpioCtrlRegs.GPADIR.bit.GPIO6 = 0;		// 1=OUTput,  0=INput  
//	GpioDataRegs.GPACLEAR.bit.GPIO6 = 0;	// uncomment if --> Set Low initially
...
//  GPIO-13 - PIN FUNCTION = --Spare--         S_Fault
	GpioCtrlRegs.GPAMUX1.bit.GPIO13 = 1;	// 0=GPIO,  1=TZ2,  2=CANRX-B,  3=MDR-B
...
//  GPIO-14 - PIN FUNCTION = --Spare--          T_Fault
	GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 1;	// 0=GPIO,  1=TZ3,  2=SCITX-B,  3=MCLKX-B
...
//  GPIO-22 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO22 = 0;	// 0=GPIO,  1=EQEPI-1,  2=MFSX-A,  3=SCIRX-B
...
//--------------------------------------------------------------------------------------
//  GPIO-58 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPBMUX2.bit.GPIO59 = 0;	// 0=GPIO,  1=MCLKR-A,  2=XD21,  3=Resv
...
//  GpioCtrlRegs.GPBCTRL.bit.QUALPRD3=1;
//  GpioCtrlRegs.GPBQSEL2.bit.GPIO59=2;
//--------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------
//  GPIO-72 - PIN FUNCTION = --Spare--             //Relay nutral Command K3
	GpioCtrlRegs.GPCMUX1.bit.GPIO72 = 0;	// 0=GPIO,  1=ECAP5,  2=XD31,  3=Resv
