...
//-----------------------Reading ADC Chanels----------------------------------
	...
	J22=(AdcMirror.ADCRESULT6*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J20=(AdcMirror.ADCRESULT7*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J18=(AdcMirror.ADCRESULT8*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J16=(AdcMirror.ADCRESULT9*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J14=(AdcMirror.ADCRESULT10*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J12=(AdcMirror.ADCRESULT11*0.00024414-0.5)*2*GAIN_CAL_IAC;
	J23=(AdcMirror.ADCRESULT12*0.00024414-0.5)*2*GAIN_CAL_IAC;


	//--------------------RMS Module Implementation--------------------------------------
	    sine_mainsJ45.Vin=J45*BASE_VOLTAGE;
	    sine_mainsJ47.Vin=J47*BASE_VOLTAGE;
	    sine_mainsJ49.Vin=J49*BASE_VOLTAGE;
	    sine_mainsJ51.Vin=J51*BASE_VOLTAGE;
	    sine_mainsJ52.Vin=J52*BASE_VOLTAGE;
	    sine_mainsJ54.Vin=J54*BASE_VOLTAGE;

	    sine_mainsJ22.Vin=J22*BASE_CURRENT;
	    sine_mainsJ20.Vin=J20*BASE_CURRENT;
	    sine_mainsJ18.Vin=J18*BASE_CURRENT;
	    sine_mainsJ16.Vin=J16*BASE_CURRENT;
	    sine_mainsJ14.Vin=J14*BASE_CURRENT;
	    sine_mainsJ12.Vin=J12*BASE_CURRENT;
	    sine_mainsJ23.Vin=J23*BASE_CURRENT;
