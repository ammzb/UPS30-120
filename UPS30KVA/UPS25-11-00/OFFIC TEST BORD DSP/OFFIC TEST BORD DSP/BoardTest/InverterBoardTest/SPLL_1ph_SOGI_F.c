...
void SPLL_1ph_SOGI_F_init(int Grid_freq, float32 DELTA_T, SPLL_1ph_SOGI_F *spll_obj)
{
	...
	spll_obj->theta120=(float32)(0.0);
	spll_obj->theta240=(float32)(0.0);
	
	spll_obj->sin=(float32)(0.0);
	spll_obj->sin120=(float32)(0.0);
	spll_obj->sin240=(float32)(0.0);
	spll_obj->cos=(float32)(0.0);
	
	spll_obj->ui=(float32)(0.0);
	spll_obj->v1=(float32)(0.0);
	spll_obj->i1=(float32)(0.0);
	spll_obj->Umax=(float32)(10.0);
	spll_obj->Umin=(float32)(-10.0);
	spll_obj->fault=0;
...
void SPLL_1ph_SOGI_F_coeff_update(float32 delta_T, float32 wn, SPLL_1ph_SOGI_F *spll)
{
	...
	osgx=(float32)(2.0*spll->osg_coeff.osg_k*wn*delta_T);
	...
	spll->osg_coeff.osg_qb0=((float32)(spll->osg_coeff.osg_k*osgy)*temp);
	spll->osg_coeff.osg_qb1=(spll->osg_coeff.osg_qb0*(float32)(2.0));
	spll->osg_coeff.osg_qb2=spll->osg_coeff.osg_qb0;
}

#pragma CODE_SECTION(SPLL_1ph_SOGI_F_FUNC, "ramfuncs2");
//*********** Function Definition ********//
...
void SPLL_1ph_SOGI_F_FUNC(SPLL_1ph_SOGI_F *spll_obj)
{
	...
	spll_obj->ui=(spll_obj->ylf[0] == spll_obj->v1) ? (spll_obj->i1 + (spll_obj->lpf_coeff.B0_lf + spll_obj->lpf_coeff.B1_lf)*spll_obj->u_Q[0]) : spll_obj->i1;
	spll_obj->i1=spll_obj->ui;

	spll_obj->v1 = (spll_obj->ui - spll_obj->lpf_coeff.B1_lf*spll_obj->u_Q[0]);

	spll_obj->ylf[0]=(spll_obj->v1 > spll_obj->Umax) ? (spll_obj->Umax) : spll_obj->v1;
	spll_obj->ylf[0] = (spll_obj->ylf[0] < spll_obj->Umin) ? (spll_obj->Umin) : spll_obj->ylf[0];
	...
	spll_obj->theta240=spll_obj->theta[0]+ (float32)(4.18879);
	spll_obj->theta120=spll_obj->theta[0]+(float32) (2.0943951);

	if(spll_obj->theta[0]>(float32)(2.0*3.1415926))
		spll_obj->theta[0]-=(float32)(2.0*3.1415926);

	if(spll_obj->theta240>(float32)(2.0*3.1415926))
		spll_obj->theta240-=(float32)(2.0*3.1415926);

	if(spll_obj->theta120>(float32)(2.0*3.1415926))
		spll_obj->theta120-=(float32)(2.0*3.1415926);
	
	spll_obj->theta[1]=spll_obj->theta[0];
	
	spll_obj->sin=(float32)sin(spll_obj->theta[0]);
	spll_obj->sin120=(float32)sin(spll_obj->theta120);
	spll_obj->sin240=(float32)sin(spll_obj->theta240);
