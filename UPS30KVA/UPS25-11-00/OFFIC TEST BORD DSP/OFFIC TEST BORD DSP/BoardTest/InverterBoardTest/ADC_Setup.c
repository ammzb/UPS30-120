...
void ADC_Setup(void)
	...
	AdcRegs.ADCCHSELSEQ1.bit.CONV00 = 2;	/*Phase R Voltage */
	AdcRegs.ADCCHSELSEQ1.bit.CONV01 = 4;	/*Phase S Voltage */			
	AdcRegs.ADCCHSELSEQ1.bit.CONV02 = 6;	/*Phase T Voltage */
	AdcRegs.ADCCHSELSEQ1.bit.CONV03 = 10;	/*Phase R Current */
	AdcRegs.ADCCHSELSEQ2.bit.CONV04 = 14;	/*Phase S Current*/
	AdcRegs.ADCCHSELSEQ2.bit.CONV05 = 12;	/*Phase T Current*/
	AdcRegs.ADCCHSELSEQ2.bit.CONV06 = 13;   /* ChSelect: ADC A4-> Low Side DC Bus Return Cur.*/
	AdcRegs.ADCCHSELSEQ2.bit.CONV07 = 11;
	AdcRegs.ADCCHSELSEQ3.bit.CONV08 = 9;	/* ChSelect: ADC A5-> Battery Voltage */
	AdcRegs.ADCCHSELSEQ3.bit.CONV09 = 0;	/* ChSelect: ADC A7->  Buck output voltage Voltage */
	AdcRegs.ADCCHSELSEQ3.bit.CONV10 = 1;	/* ChSelect: ADC B7-> Buck Output Current */
	AdcRegs.ADCCHSELSEQ3.bit.CONV11 = 3;	/* ChSelect: ADC B3-> V Phase A */
	AdcRegs.ADCCHSELSEQ4.bit.CONV12 = 5;	/* ChSelect: ADC B2-> V Phase B */
