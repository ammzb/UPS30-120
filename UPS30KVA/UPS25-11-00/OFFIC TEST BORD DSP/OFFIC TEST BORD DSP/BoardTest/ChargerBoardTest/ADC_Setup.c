...
void ADC_Setup(void)
	...
	AdcRegs.ADCCHSELSEQ3.bit.CONV08 = 15;	/* ChSelect: ADC A5-> Battery Voltage */
	AdcRegs.ADCCHSELSEQ3.bit.CONV09 = 13;	/* ChSelect: ADC A7->  Buck output voltage Voltage */
	AdcRegs.ADCCHSELSEQ3.bit.CONV10 = 11;	/* ChSelect: ADC B7-> Buck Output Current */
	AdcRegs.ADCCHSELSEQ3.bit.CONV11 = 14;	/* ChSelect: ADC B3-> V Phase A */
	AdcRegs.ADCCHSELSEQ4.bit.CONV12 = 12;	/* ChSelect: ADC B2-> V Phase B */
	AdcRegs.ADCCHSELSEQ4.bit.CONV13 = 10;	/* ChSelect: ADC B1-> V Phase C */
