...
//-----------------------Reading ADC Chanels----------------------------------
 	//offset=(int16)AdcMirror.ADCRESULT11 - 2048;
		...
		J21=(AdcMirror.ADCRESULT8*0.00024414-0.5)*2*GAIN_CAL_IAC;
		J19=(AdcMirror.ADCRESULT9*0.00024414-0.5)*2*GAIN_CAL_IAC;
		J17=(AdcMirror.ADCRESULT10*0.00024414-0.5)*2*GAIN_CAL_IAC;
		J15=(AdcMirror.ADCRESULT11*0.00024414-0.5)*2*GAIN_CAL_IAC;
		J13=(AdcMirror.ADCRESULT12*0.00024414-0.5)*2*GAIN_CAL_IAC;
		J11=(AdcMirror.ADCRESULT13*0.00024414-0.5)*2*GAIN_CAL_IAC;


		//--------------------RMS Module Implementation--------------------------------------
		    sine_mainsJ44.Vin=J44*VAC_NOM;
		    sine_mainsJ46.Vin=J46*VAC_NOM;
		    sine_mainsJ48.Vin=J48*VAC_NOM;
		    sine_mainsJ50.Vin=J50*VAC_NOM;
		    sine_mainsJ53.Vin=J53*VAC_NOM;
		    sine_mainsJ55.Vin=J55*VAC_NOM;
		    sine_mainsJ56.Vin=J56*VAC_NOM;
		    sine_mainsJ57.Vin=J57*VAC_NOM;

		    sine_mainsJ21.Vin=J21*IAC_NOM;
		    sine_mainsJ19.Vin=J19*IAC_NOM;
		    sine_mainsJ17.Vin=J17*IAC_NOM;
		    sine_mainsJ15.Vin=J15*IAC_NOM;
		    sine_mainsJ13.Vin=J13*IAC_NOM;
		    sine_mainsJ11.Vin=J11*IAC_NOM;
