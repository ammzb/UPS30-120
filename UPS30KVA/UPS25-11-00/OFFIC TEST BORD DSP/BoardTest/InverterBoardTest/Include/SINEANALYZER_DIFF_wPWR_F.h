...
typedef struct {
	...
	float32 Pavg;            // Output: Average Power
	float32 Papp;             //Output: Apparent Power
	...
	float32 Cosphi;             //Output: Power Factor
	...
	Uint32  nsamples1;			// Internal: No of samples in one cycle of the sine wave
