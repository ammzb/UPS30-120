...
#define PG_BOOST_OFF_CYCLES               150
#define	PG_SYNC_INV_CYCLES                300
...
#ifdef Grid_220_750    // nominal inverter current for cos(phi)=0.8 = 36A RMS  
...
#define GAIN_CAL_VDC 2.4             //510/750
